    ...
    public abstract class SpriteKernelNew : ISpriteNew
    {
        ...
        public Rectangle GetDestination(Vector2 location)
        {
            return new Rectangle(
                (int)location.X - Source.Default.Coodinates[Animation.Default.GetValue()].Width/2,
                (int)location.Y - Source.Default.Coodinates[Animation.Default.GetValue()].Height,
                Source.Default.Coodinates[Animation.Default.GetValue()].Width,
                Source.Default.Coodinates[Animation.Default.GetValue()].Height
                );
        }
    }
}