...
namespace SuperMario
{
    public class ExplodingLargeFireballSprite : SpriteKernelNew
    {
        public ExplodingLargeFireballSprite()
        {
            ...
            SetAnimation(new []
            {
                SpriteTransformation.Center(0, SpriteEffects.None, 0, null, 1.3f),
                SpriteTransformation.Center(1, SpriteEffects.None, 0, null, 1.45f),
                SpriteTransformation.Center(2, SpriteEffects.None, 0, null, 1.6f)
            });
        }
    }
}
